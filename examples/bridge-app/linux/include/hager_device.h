...
public:
    ...
    Device(const char * szDeviceName, std::string szLocation, std::string deviceUid);
    virtual ~Device() {}
...
public:
    ...
    DeviceOnOff(const char * szDeviceName, std::string szLocation, std::string deviceUid);
