...
Device::Device(const char * szDeviceName, std::string szLocation, std::string deviceUid)
{
...
DeviceOnOff::DeviceOnOff(const char * szDeviceName, std::string szLocation, std::string deviceUid) : Device(szDeviceName, szLocation, deviceUid)
{
    mOn = false;
}
